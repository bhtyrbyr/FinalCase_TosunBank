...
public class SingupMappingProfile : Profile
{
    ...
    {
        CreateMap<NewCustomerAccountOpeningRequest, SignUpViewDTO>();
        CreateMap<SignUpCreateDTO, NewCustomerAccountOpeningRequest>();
        CreateMap<NewCustomerAccountOpeningRequest, Customer>()
