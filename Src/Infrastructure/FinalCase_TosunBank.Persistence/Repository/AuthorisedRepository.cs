...
public class AuthorisedRepository : GenericRepository<Authorised, string>, IAuthorisedRepository
{
    public AuthorisedRepository(TosunBankDbContext dbContext) : base(dbContext)
    {
    }
}
